...
Launching a DAO Ships ship means deploying a complete on-chain organization — governance, two tokens, and a secured treasury — in a single transaction. The app guides you through it with a **7-step wizard** at [app.daoships.xyz/launch](https://app.daoships.xyz/launch). This guide walks each step, explains what every field means, and offers sane defaults so you can launch with confidence.
...
Before you start, make sure your [wallet is set up](/docs/guides/wallet-setup) and funded with testnet QUAI on Cyprus-1.
