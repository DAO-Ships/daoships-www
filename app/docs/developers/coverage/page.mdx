...
Reviewed **12 September 2026**: SDK **0.1.0-alpha.3** and CLI **0.1.0-alpha.2**. Rechecked **23 September 2026** for SDK **0.1.0-alpha.4** and CLI **0.1.0-alpha.3**: the contract interfaces (353 functions, 103 events) and the 88-command registry are unchanged. Every function in the supported DAO and navigator interfaces is accessible from both packages. Function availability, successful local execution and live-network acceptance are different kinds of evidence; this page records each separately.
