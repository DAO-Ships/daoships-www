...
The [TypeScript SDK](/docs/developers/sdk#indexed-data-with-exact-amounts) supplies typed,
precision-preserving reads for all 25 public tables. The [CLI](/docs/developers/cli) exposes
them through `indexer tables`, `indexer list`, `indexer count` and `indexer get`.
