...
[Contracts](/docs/developers/contracts).
...
const launcher = new quais.Contract(
  "0x0030d87f987F24603108bEe81cE212a007Bfb6dD", // DAOShipAndVaultLauncher
...
const poster = new quais.Contract(
  "0x0028DCeb1CAfb4d6B2B5f69313329Aeb0E66cf34", // Poster
  [
