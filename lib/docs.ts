...
export const docsNav: DocSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: "TypeScript SDK", href: "/docs/developers/sdk" },
      { title: "CLI & terminal workspace", href: "/docs/developers/cli" },
      { title: "CLI command reference", href: "/docs/developers/cli-reference" },
      { title: "SDK & CLI coverage", href: "/docs/developers/coverage" },
...
const KEYWORDS: Record<string, string> = {
  ...
  "/docs/developers/sdk": "typescript sdk npm provider contractclient governance navigator launch recovery indexer bigint api",
